...
import { X, Settings, Zap, TestTube, CheckCircle, AlertCircle, Loader } from 'lucide-react';
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Configure your AI therapy experience</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center space-x-2">
                            ...
                            <h3 className="text-lg font-medium text-gray-900">AI Generation Settings</h3>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-2">
                                ...
                                <h3 className="text-lg font-medium text-gray-900">Service Diagnostics</h3>
                            </div>
                            <button
                        ...
                        {lastTestTime && (
                            <p className="text-sm text-gray-500">Last tested: {lastTestTime}</p>
                        )}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900">Hugging Face AI</h4>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-gray-500">{diagnostics.huggingFace.message}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">AI video generation</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-gray-500">{diagnostics.tavus.message}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-blue-200">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-gray-500">{diagnostics.overall.message}</p>
                                    </div>
                                </div>
                            </div>
                        )}
                    ...
                    <div className="space-y-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                            <p>• <strong>VITE_HUGGINGFACE_API_KEY</strong>: Required for AI text generation (free from huggingface.co)</p>
                            <p>• <strong>VITE_TAVUS_API_KEY</strong>: Required for AI video generation (from tavus.io)</p>
                            <p>• <strong>VITE_ELEVENLABS_API_KEY</strong>: Required for AI voice generation (from elevenlabs.io)</p>
                        </div>
