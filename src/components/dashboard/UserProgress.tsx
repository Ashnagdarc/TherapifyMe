...
export const UserProgress = ({ stats }: UserProgressProps) => (
    <div className="bg-gray-800/50 p-4 rounded-lg">
        ...
        <div className="space-y-2 text-sm">
            <div className="flex justify-between">
                ...
                <span className="text-white font-medium">{stats?.totalEntries || 0}</span>
            </div>
            <div className="flex justify-between">
                <span className="text-gray-300">Active Days</span>
                <span className="text-white font-medium">{stats?.activeDays || 0}</span>
            </div>
            <div className="flex justify-between">
