        ...
        <div className="grid gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xs border border-grey p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-text-black py-2">
                      {LANGUAGE_OPTIONS.find(
                        (lang) => lang.value === profile?.language
                      )?.label || "English"}
                    </p>
                  )}
                </div>
              ...
              {/* Stats */}
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-primery">
                  Your Journey
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-main bg-opacity-10 rounded-lg p-4 text-center">
                    ...
                    <div className="text-xs text-text-black">
                      Total Check-ins
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-text-black text-sm mb-4">
                  Choose how you'd like your AI companion to respond to your
                  check-ins
                </p>
                  ...
                  {TONE_OPTIONS.map((tone) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          isEditing &&
                          handleInputChange("preferred_tone", e.target.value)
                        }
                        className="sr-only"
                        disabled={!isEditing}
                      />
                      ...
                      <div className="flex-1">
                        <div className="font-medium text-primery">
                          {tone.label}
                        </div>
              ...
              <div className="border-t border-grey pt-6">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <h3 className="text-lg font-medium text-primery">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="space-y-2">
                    <input
                      ...
                      value={aiPercentage}
                      onChange={(e) =>
                        setAiPercentage(parseInt(e.target.value))
                      }
                      disabled={!isEditing}
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <p className="text-sm text-text-black">
                    Minimum confidence required to use AI responses. Lower
                    values accept more AI responses, higher values fall back to
                    templates more often.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <h4 className="font-medium text-primery">
                        Service Diagnostics
                      </h4>
                    </div>
                    <button
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between p-3 bg-grey-2 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h5 className="font-medium text-primery text-sm">
                              Hugging Face AI
                            </h5>
                  ...
                  <div className="space-y-2 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <div className="space-y-1 text-xs text-text-black">
                      <p>
                        • <strong>VITE_HUGGINGFACE_API_KEY</strong>: Free AI
                        text generation
                      </p>
                      <p>
                        • <strong>VITE_TAVUS_API_KEY</strong>: AI video
                        generation
                      </p>
                      <p>
                        • <strong>VITE_ELEVENLABS_API_KEY</strong>: AI voice
                        generation
                      </p>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-grey">
                <div>
                  ...
                  <p className="text-sm text-text-black">
                    Download all your check-ins and responses
                  </p>
                </div>
                <Button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-primery mb-2">
                Delete Account
              </h3>
              <p className="text-text-black mb-6">
                Are you sure you want to delete your account? This action cannot
                be undone and will permanently delete all your check-ins,
                responses, and data.
              </p>
